<?php if (($chat->iwh_id > 0 && ($incomingWebhook = erLhcoreClassModelChatIncomingWebhook::fetch($chat->iwh_id)) instanceof erLhcoreClassModelChatIncomingWebhook) && $incomingWebhook->scope == 'birdappwhatsapp' ) : ?>
    <div class="me-auto">
